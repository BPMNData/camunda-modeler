 ...
 * <ul>
 *   <li>{@link de.unipotsdam.hpi.bpmndata.schemamapping.AttributeMapping#getLocalAttribute <em>Local Attribute</em>}</li>
 *   <li>{@link de.unipotsdam.hpi.bpmndata.schemamapping.AttributeMapping#getGlobalAttribute <em>Global Attribute</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.unipotsdam.hpi.bpmndata.schemamapping.SchemamappingPackage#getAttributeMapping()
 * @model
 * @generated
 */
public interface AttributeMapping extends EObject {
   ...
   * @see de.unipotsdam.hpi.bpmndata.schemamapping.SchemamappingPackage#getAttributeMapping_LocalAttribute()
  ...
  /**
   * Sets the value of the '{@link de.unipotsdam.hpi.bpmndata.schemamapping.AttributeMapping#getLocalAttribute <em>Local Attribute</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see de.unipotsdam.hpi.bpmndata.schemamapping.SchemamappingPackage#getAttributeMapping_GlobalAttribute()
   * @model required="true" derived="true"
  ...
  /**
   * Sets the value of the '{@link de.unipotsdam.hpi.bpmndata.schemamapping.AttributeMapping#getGlobalAttribute <em>Global Attribute</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->

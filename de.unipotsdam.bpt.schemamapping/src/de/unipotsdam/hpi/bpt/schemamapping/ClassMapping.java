 ...
 * <ul>
 *   <li>{@link de.unipotsdam.hpi.bpt.schemamapping.ClassMapping#getLocalClass <em>Local Class</em>}</li>
 *   <li>{@link de.unipotsdam.hpi.bpt.schemamapping.ClassMapping#getGlobalClass <em>Global Class</em>}</li>
 *   <li>{@link de.unipotsdam.hpi.bpt.schemamapping.ClassMapping#getAttributeMappings <em>Attribute Mappings</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.unipotsdam.hpi.bpt.schemamapping.SchemamappingPackage#getClassMapping()
...
public interface ClassMapping extends EObject {
   ...
   * @see de.unipotsdam.hpi.bpt.schemamapping.SchemamappingPackage#getClassMapping_LocalClass()
  ...
  /**
   * Sets the value of the '{@link de.unipotsdam.hpi.bpt.schemamapping.ClassMapping#getLocalClass <em>Local Class</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see de.unipotsdam.hpi.bpt.schemamapping.SchemamappingPackage#getClassMapping_GlobalClass()
   * @model required="true" derived="true"
  ...
  /**
   * Sets the value of the '{@link de.unipotsdam.hpi.bpt.schemamapping.ClassMapping#getGlobalClass <em>Global Class</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * The list contents are of type {@link de.unipotsdam.hpi.bpt.schemamapping.AttributeMapping}.
   * <!-- begin-user-doc -->
   * <p>
   ...
   * @see de.unipotsdam.hpi.bpt.schemamapping.SchemamappingPackage#getClassMapping_AttributeMappings()
   * @model type="de.unipotsdam.hpi.bpt.schemamapping.AttributeMapping" containment="true" derived="true" ordered="false"

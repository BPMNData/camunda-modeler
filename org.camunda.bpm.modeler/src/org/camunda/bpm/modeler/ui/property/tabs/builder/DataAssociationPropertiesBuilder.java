...
public class DataAssociationPropertiesBuilder extends
        AbstractPropertiesBuilder<DataAssociation> {

    private static final EStructuralFeature CARDINALITY_FEATURE = BptPackage.eINSTANCE
            .getDocumentRoot_Cardinality();

    private static final EStructuralFeature CONDITION_FEATURE = BptPackage.eINSTANCE
            .getDocumentRoot_Condition();

    public DataAssociationPropertiesBuilder(Composite parent,
            GFPropertySection section, DataAssociation bo) {
    ...
    private void createCardinalityCondition() {
        final Text cardinalityText = PropertyUtil.createUnboundText(section,
                parent, "Cardinality");
        ...
        new ExtensionTextBinding<Cardinality>(bo, CARDINALITY_FEATURE,
                cardinalityText, "value", cardinalityFactory).establish();
    }

    private void createConditionControl() {
        final Text conditionText = PropertyUtil.createUnboundText(section,
                parent, "Condition");
        ...
        new ExtensionTextBinding<Condition>(bo, CONDITION_FEATURE,
                conditionText, "value", conditionFactory).establish();
    }

    /**
     * Generic binding for simple extension.
     */
    private class ExtensionTextBinding<T extends EObject> extends
            ModelTextBinding<String> {

        private String attributeName;
        private ExtensionAdapter<T> extensionAdapter;

        public ExtensionTextBinding(EObject model, EStructuralFeature feature,
                Text control, String attributeName,
                ExtensionAdapter<T> extensionFactory) {
        ...
        public String getModelValue() {
            return (String) ExtensionUtil.getExtension(bo, feature,
                    attributeName);
        }
        ...
        protected void transactionalUpdate(String newValue) {
            ...
            domain.getCommandStack().execute(
                    new UpdateCommand(domain, newValue));
        }
        ...
        private class UpdateCommand extends RecordingCommand {
            ...
            public UpdateCommand(TransactionalEditingDomain domain,
                    String newValue) {
                super(domain);

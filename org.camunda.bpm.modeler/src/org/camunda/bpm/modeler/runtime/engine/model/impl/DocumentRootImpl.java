 ...
 *   <li>{@link org.camunda.bpm.modeler.runtime.engine.model.impl.DocumentRootImpl#getAddress <em>Address</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DocumentRootImpl extends org.eclipse.bpmn2.impl.DocumentRootImpl implements DocumentRoot {
   ...
   * @generated
   */
  public NotificationChain basicSetAddress(EndPointAddress newAddress, NotificationChain msgs) {
    EndPointAddress oldAddress = address;
    address = newAddress;
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ModelPackage.DOCUMENT_ROOT__ADDRESS, oldAddress, newAddress);
   ...
   * @generated
   */
  public void setAddress(EndPointAddress newAddress) {
    if (newAddress != address) {
      NotificationChain msgs = null;
      if (address != null)
        msgs = ((InternalEObject)address).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ModelPackage.DOCUMENT_ROOT__ADDRESS, null, msgs);
      if (newAddress != null)
        msgs = ((InternalEObject)newAddress).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ModelPackage.DOCUMENT_ROOT__ADDRESS, null, msgs);
      msgs = basicSetAddress(newAddress, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.DOCUMENT_ROOT__ADDRESS, newAddress, newAddress));
  }
   ...
   */
    ...
    switch (featureID) {
      ...
      case ModelPackage.DOCUMENT_ROOT__ADDRESS:
   ...
   */
    ...
    switch (featureID) {
      ...
      case ModelPackage.DOCUMENT_ROOT__FAILED_JOB_RETRY_TIME_CYCLE:
        ...
        return;
      case ModelPackage.DOCUMENT_ROOT__ADDRESS:
        setAddress((EndPointAddress)newValue);
        return;
    }
   ...
   */
    ...
    switch (featureID) {
      ...
      case ModelPackage.DOCUMENT_ROOT__FAILED_JOB_RETRY_TIME_CYCLE:
        ...
        return;
      case ModelPackage.DOCUMENT_ROOT__ADDRESS:
        setAddress((EndPointAddress)null);
        return;
    }

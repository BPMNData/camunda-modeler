...
public class ModelSwitch<T> extends Switch<T> {
   ...
   */
    ...
    switch (classifierID) {
      ...
      case ModelPackage.END_POINT_ADDRESS: {
        EndPointAddress endPointAddress = (EndPointAddress)theEObject;
        T result = caseEndPointAddress(endPointAddress);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
   ...
   */
	...
	/**
   * Returns the result of interpreting the object as an instance of '<em>End Point Address</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>End Point Address</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  public T caseEndPointAddress(EndPointAddress object) {
    return null;
  }

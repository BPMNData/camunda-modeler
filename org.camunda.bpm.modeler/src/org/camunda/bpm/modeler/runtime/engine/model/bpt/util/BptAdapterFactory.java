...
public class BptAdapterFactory extends AdapterFactoryImpl {
   ...
   */
    protected BptSwitch<Adapter> modelSwitch =
      ...
      @Override
      public Adapter caseMessageContentDefinition(MessageContentDefinition object) {
      ...
      @Override
      public Adapter caseCorrelationInformation(CorrelationInformation object) {
        return createCorrelationInformationAdapter();
      }
      @Override
   ...
   */
    ...
    /**
   * Creates a new adapter for an object of class '{@link org.camunda.bpm.modeler.runtime.engine.model.bpt.MessageContentDefinition <em>Message Content Definition</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
  ...
  public Adapter createItemDefinitionLinkAdapter() {
    ...
    /**
   * Creates a new adapter for an object of class '{@link org.camunda.bpm.modeler.runtime.engine.model.bpt.MessageObject <em>Message Object</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
   ...
   * @generated
   */
  public Adapter createMessageObjectAdapter() {
    return null;
  }

    /**
   * Creates a new adapter for an object of class '{@link org.camunda.bpm.modeler.runtime.engine.model.bpt.CorrelationInformation <em>Correlation Information</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
   ...
   * @generated
   */
  public Adapter createCorrelationInformationAdapter() {
    return null;
  }

    /**
   * Creates a new adapter for an object of class '{@link org.camunda.bpm.modeler.runtime.engine.model.bpt.StructureDefinition <em>Structure Definition</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->

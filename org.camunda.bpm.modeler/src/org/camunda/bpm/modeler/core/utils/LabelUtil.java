...
public class LabelUtil {
  ...
  /**
   * Returns the label of a given pictogram element (connected via the elements
   * business object) in the scope of the given diagram.
   * 
  ...
  /**
   * Tells whether it is possible to create a label for this element.
   */
   ...
   */
  public static String getLabelText(BaseElement element) {
    if (element == null)
      return "(no element)";
  ...
  /**
   * Returns the corresponding non label pictogram element for a given label
   * shape (connected via the elements business object) in the scope of the
   * given diagram.
   * 
   * @param pictogramElement
   * @param diagram
  ...
  /**
   * Returns non label pictogram element for a given business object in the
   * scope of the given diagram.
   * 
   * @param bpmnElement
   * @param diagram
   * 
  ...
  /**
   * Returns the label of the given business object in the scope of the given
   * diagram.
   * 
   * @param bpmnElement
   * @param diagram
   ...
   * 
   * The position returned is the top middle point of the shape in absolute
   * coordinates.
   * 
   * @param labelShape
   * @return
  ...
  /**
   * Return the required label adjustment to align the label according to its
   * offset.
   * 
   * @param labelShape
   * @param labeledShape

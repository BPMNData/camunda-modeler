...
public class ExtensionUtil {
     ...
     * @return
     */
    public static Object getExtension(EObject object,
            EStructuralFeature feature, String attributeName) {
        ...
        if (extensionAttributeValue != null) {
            ...
            if (featureObject instanceof FeatureMapUtil.FeatureEList<?>) {
                ...
                if (featureList.size() == 1) {
                    ...
                    EList<EStructuralFeature> features = eFeatureObject
            ...
            while (iterator.hasNext()) {
                ...
                if (featureName.equals(entry.getEStructuralFeature().getName())) {
                    ...
                    if (value instanceof AnyType) {
                        ...
                        FeatureMap.Entry anyTypeEntry = anyType.getMixed().get(
                                0);
                        if (attributeName.equals(anyTypeEntry
    ...
    public static <T> List<T> getExtensions(EObject object, Class<T> cls) {
        ...
        EStructuralFeature extensionValuesFeature = object.eClass()
                .getEStructuralFeature("extensionValues");
        EList<ExtensionAttributeValue> list = (EList<ExtensionAttributeValue>) object
                .eGet(extensionValuesFeature);
     ...
     * @param value
     */
    public static void addExtension(EObject object, EStructuralFeature feature,
            EObject value) {
        EStructuralFeature extensionValuesFeature = object.eClass()
                .getEStructuralFeature("extensionValues");
     ...
     * @param feature
     */
    public static void removeExtensionByFeature(EObject object,
     ...
     */
    public static void removeExtensionByValue(EObject object,
            EObject extensionValue) {

        EStructuralFeature extensionValuesFeature = object.eClass()
                .getEStructuralFeature("extensionValues");
        EList<ExtensionAttributeValue> extensionAttributesList = (EList<ExtensionAttributeValue>) object
                .eGet(extensionValuesFeature);
     ...
     * @return
     */
    public static List<ExtensionAttributeValue> getExtensionAttributeValues(
            EObject object) {
        ...
        if (object instanceof Participant) {
            ...
            if (participant.getProcessRef() == null) {
                if (participant.eContainer() instanceof Collaboration) {
                    Collaboration collab = (Collaboration) participant
                            .eContainer();
                    if (collab.eContainer() instanceof Definitions) {
                        final Definitions definitions = ModelUtil
                                .getDefinitions(collab);
                        ...
                        domain.getCommandStack().execute(
                                new RecordingCommand(domain) {
                                    ...
                                    protected void doExecute() {
                                        Process process = Bpmn2ModelerFactory
                                                .create(Process.class);
                                        participant.setProcessRef(process);
                                        definitions.getRootElements().add(
                                                process);
    ...
    /**
     * Return the extension attribute value for a given object in which to store
     * extensions.
     * 
     * @param object
     * @return
     */
    public static ExtensionAttributeValue getExtensionAttributeValue(
            EObject object) {

        EStructuralFeature extensionValuesFeature = object.eClass()
                .getEStructuralFeature("extensionValues");
        EList<ExtensionAttributeValue> extensionAttributeValues = (EList<ExtensionAttributeValue>) object
                .eGet(extensionValuesFeature);

        if (extensionAttributeValues != null
                && extensionAttributeValues.size() == 1) {
    ...
    public static void updateExtension(EObject object,
        ...
        if (extensionElements != null) {
            ...
            enforceNotification(extensionElements);
        }
    }

    /**
     * This is kind of hacky but a non-invasive solution to enforce change
     * notification of our business object when dealing with extensions. Once a
     * there is an ExtensionAttributeValue for a business object, we need to add
     * our extensions there. But since we only operate on the
     * ExtensionAttributeValue, there will be no automatic EMF notifications for
